...
namespace control_msgs
{
  ...
  class PointHeadGoal : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      uint32_t * length_pointing_frame = (uint32_t *)(outbuffer + offset);
      *length_pointing_frame = strlen( (const char*) this->pointing_frame);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      uint32_t length_pointing_frame = *(uint32_t *)(inbuffer + offset);
      offset += 4;
