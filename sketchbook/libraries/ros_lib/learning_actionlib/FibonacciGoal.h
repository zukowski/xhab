#ifndef _ROS_learning_actionlib_FibonacciGoal_h
#define _ROS_learning_actionlib_FibonacciGoal_h
...
namespace learning_actionlib
{
  ...
  class FibonacciGoal : public ros::Msg
  {
    ...
    const char * getType(){ return "learning_actionlib/FibonacciGoal"; };
