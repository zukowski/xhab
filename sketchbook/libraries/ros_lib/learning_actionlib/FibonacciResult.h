#ifndef _ROS_learning_actionlib_FibonacciResult_h
#define _ROS_learning_actionlib_FibonacciResult_h
...
namespace learning_actionlib
{
  ...
  class FibonacciResult : public ros::Msg
  {
    ...
    const char * getType(){ return "learning_actionlib/FibonacciResult"; };
