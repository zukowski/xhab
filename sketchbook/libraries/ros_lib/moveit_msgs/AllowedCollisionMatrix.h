  ...
  class AllowedCollisionMatrix : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_entry_namesi = (uint32_t *)(outbuffer + offset);
      *length_entry_namesi = strlen( (const char*) this->entry_names[i]);
      offset += 4;
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_default_entry_namesi = (uint32_t *)(outbuffer + offset);
      *length_default_entry_namesi = strlen( (const char*) this->default_entry_names[i]);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      for( uint8_t i = 0; i < entry_names_length; i++){
      uint32_t length_st_entry_names = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      for( uint8_t i = 0; i < default_entry_names_length; i++){
      uint32_t length_st_default_entry_names = *(uint32_t *)(inbuffer + offset);
      offset += 4;
