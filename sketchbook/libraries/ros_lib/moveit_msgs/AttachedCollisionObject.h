  ...
  class AttachedCollisionObject : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_touch_linksi = (uint32_t *)(outbuffer + offset);
      *length_touch_linksi = strlen( (const char*) this->touch_links[i]);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      for( uint8_t i = 0; i < touch_links_length; i++){
      uint32_t length_st_touch_links = *(uint32_t *)(inbuffer + offset);
      offset += 4;
    ...
    const char * getMD5(){ return "55ba14ebd240179ef80d6afcf929a817"; };
