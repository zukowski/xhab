  ...
  class ContactInformation : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset++) = (exp_depth>>4) & 0x7F;
      ...
      uint32_t * length_contact_body_1 = (uint32_t *)(outbuffer + offset);
      *length_contact_body_1 = strlen( (const char*) this->contact_body_1);
      offset += 4;
      ...
      *(outbuffer + offset + 3) = (this->body_type_1 >> (8 * 3)) & 0xFF;
      ...
      uint32_t * length_contact_body_2 = (uint32_t *)(outbuffer + offset);
      *length_contact_body_2 = strlen( (const char*) this->contact_body_2);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      *val_depth |= ((uint32_t)(*(inbuffer + offset)) & 0x0f)<<19;
      ...
      uint32_t length_contact_body_1 = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      offset += sizeof(this->body_type_1);
      uint32_t length_contact_body_2 = *(uint32_t *)(inbuffer + offset);
      offset += 4;
