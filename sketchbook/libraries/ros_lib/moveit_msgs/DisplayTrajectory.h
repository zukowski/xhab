...
namespace moveit_msgs
{
  ...
  class DisplayTrajectory : public ros::Msg
  {
    ...
    {
      int offset = 0;
      uint32_t * length_model_id = (uint32_t *)(outbuffer + offset);
      *length_model_id = strlen( (const char*) this->model_id);
      offset += 4;
    ...
    {
      int offset = 0;
      uint32_t length_model_id = *(uint32_t *)(inbuffer + offset);
      offset += 4;
    ...
    const char * getMD5(){ return "f6c3b25f9a3089124d182ffbbcaad6fb"; };
