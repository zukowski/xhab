...
static const char GETPOSITIONFK[] = "moveit_msgs/GetPositionFK";
  ...
  class GetPositionFKRequest : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_fk_link_namesi = (uint32_t *)(outbuffer + offset);
      *length_fk_link_namesi = strlen( (const char*) this->fk_link_names[i]);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      for( uint8_t i = 0; i < fk_link_names_length; i++){
      uint32_t length_st_fk_link_names = *(uint32_t *)(inbuffer + offset);
      offset += 4;
    ...
    const char * getMD5(){ return "b1a5e9a03a03700c2a6ec8cb181e717f"; };
  ...
  class GetPositionFKResponse : public ros::Msg
  {
    ...
    const char * getType(){ return GETPOSITIONFK; };
    const char * getMD5(){ return "3825ead14b61972a0562bb860392879c"; };
