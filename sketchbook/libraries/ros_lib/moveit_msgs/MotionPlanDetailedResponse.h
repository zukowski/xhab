  ...
  class MotionPlanDetailedResponse : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_descriptioni = (uint32_t *)(outbuffer + offset);
      *length_descriptioni = strlen( (const char*) this->description[i]);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      for( uint8_t i = 0; i < description_length; i++){
      uint32_t length_st_description = *(uint32_t *)(inbuffer + offset);
      offset += 4;
    ...
    const char * getMD5(){ return "339c94ad775dce0e1d618484011913dc"; };
