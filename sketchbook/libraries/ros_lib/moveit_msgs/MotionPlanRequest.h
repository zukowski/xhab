  ...
  class MotionPlanRequest : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset++) = 0;
      ...
      uint32_t * length_planner_id = (uint32_t *)(outbuffer + offset);
      *length_planner_id = strlen( (const char*) this->planner_id);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      uint32_t length_planner_id = *(uint32_t *)(inbuffer + offset);
      offset += 4;
    ...
    const char * getMD5(){ return "abf219e07b2f640134af6d7b58b39dcf"; };
