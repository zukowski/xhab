  ...
  class PlanningScene : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *length_name = strlen( (const char*) this->name);
      ...
      uint32_t * length_robot_model_name = (uint32_t *)(outbuffer + offset);
      *length_robot_model_name = strlen( (const char*) this->robot_model_name);
      offset += 4;
      memcpy(outbuffer + offset, this->robot_model_name, *length_robot_model_name);
      offset += *length_robot_model_name;
      uint32_t * length_robot_model_root = (uint32_t *)(outbuffer + offset);
      *length_robot_model_root = strlen( (const char*) this->robot_model_root);
      offset += 4;
      memcpy(outbuffer + offset, this->robot_model_root, *length_robot_model_root);
      offset += *length_robot_model_root;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      uint32_t length_robot_model_name = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      offset += length_robot_model_name;
      uint32_t length_robot_model_root = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      for(unsigned int k= offset; k< offset+length_robot_model_root; ++k){
          inbuffer[k-1]=inbuffer[k];
      }
      inbuffer[offset+length_robot_model_root-1]=0;
      this->robot_model_root = (char *)(inbuffer + offset-1);
      offset += length_robot_model_root;
    ...
    const char * getMD5(){ return "4d171dc5332f703dc4be95429c08f121"; };
