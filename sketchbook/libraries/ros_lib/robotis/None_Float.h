#ifndef _ROS_SERVICE_None_Float_h
#define _ROS_SERVICE_None_Float_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char NONE_FLOAT[] = "robotis/None_Float";

  class None_FloatRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return NONE_FLOAT; };
    const char * getMD5(){ return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class None_FloatResponse : public ros::Msg
  {
    public:
      float value;
