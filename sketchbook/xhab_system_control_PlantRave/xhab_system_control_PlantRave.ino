...
*/
  //LED LOOP/////////////////////////////////////////////////
      ...
      digitalWrite(LED_6,LOW);//red
      digitalWrite(LED_6 + 1, LOW);//red
      digitalWrite(LED_5, LOW);     
      digitalWrite(LED_5 + 1, LOW);
      delay(107);//107ms for sandstorm beat freq/4
      digitalWrite(LED_5, HIGH);     
      digitalWrite(LED_5 + 1, HIGH);
      ...
      digitalWrite(LED_4 + 1,LOW);
      delay(107);//107ms for sandstorm beat freq/4
      digitalWrite(LED_6,HIGH);//red
      digitalWrite(LED_6 + 1, HIGH);//red
      digitalWrite(LED_4, HIGH);     
      digitalWrite(LED_4 + 1, HIGH);
      digitalWrite(LED_3,LOW);
      digitalWrite(LED_3 + 1,LOW);
      delay(107);//107ms for sandstorm beat freq/4
